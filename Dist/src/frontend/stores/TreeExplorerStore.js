    ...
    changeSearch(text) {
        ...
        if (!text || SearchUtils.trimSearchText(text).length === 0) {
            ...
            if (this.searchRoots
                ...
                this.searchRoots = Object.keys(this.nodesById).filter(key => nodeMatchesText_1.default(this.nodesById[key], needle, key, this));
            }
        ...
        if (data.children) {
            data.children.forEach(childId => {
                ...
                if (!this.nodeParentsById[childId]) {
                    ...
                    if (this.searchRoots
                        && childNode // fixme
                        && nodeMatchesText_1.default(childNode, this.searchText.toLowerCase(), childId, this)) {
