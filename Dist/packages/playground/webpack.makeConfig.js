...
exports.makeConfig = ({ pages = ['amsterdam', 'baltimore', 'casablanca', 'denmark'], plainDevtool = false, }) => ({
    devtool: 'eval',
    entry: pages.reduce((acc, entry) => Object.assign(acc, {
        [entry]: [
...
exports.startDevServer = options => new Promise((resolve, reject) => {
    ...
    const playDevServer = new WebpackDevServer(compiler, Object.assign({}, webpackConfig.devServer, { publicPath: webpackConfig.output.publicPath }));
