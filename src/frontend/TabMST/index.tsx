...
export default class TabMST extends React.PureComponent<Partial<{mstFound, mstLogEnabled, length, rootsIds, rootNamesById, activeRootId, activeLogItemIndex, toggleMstLogging, activateRootId, activateLogItemIndex, commitAll}>> {
  static propTypes = {
