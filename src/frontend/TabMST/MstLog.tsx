...
export default class Log extends React.PureComponent<Partial<{logItemsIds, logItemsById, activeRootId, selectedLogItemId, activeLogItemId, activateLogItemId, cancelLogItemId, commitLogItemId, selectLogItemId}>> {
	static propTypes = {
