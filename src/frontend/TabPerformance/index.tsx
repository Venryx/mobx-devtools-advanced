...
export default class TabPerformance extends React.PureComponent<Partial<{updatesEnabled, toggleShowingUpdates, toggleFastUpdates, toggleMediumUpdates, toggleSlowUpdates, updatesFilterByDuration}>> {
	static propTypes = {
