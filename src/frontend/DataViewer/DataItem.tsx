...
export default class DataItem extends React.Component<{startOpen, name, path, editable, getValueByPath, change, inspect, stopInspecting, showMenu, ChildDataView, ChildDataItem}, {open: boolean}> {
  static propTypes = {
