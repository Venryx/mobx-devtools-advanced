...
export default class SplitPane extends React.Component<Partial<{initialWidth, initialHeight, left, right, isVertical}>, {moving: boolean, width: number, height: number, isVertical?: boolean}> {
	static propTypes = {
