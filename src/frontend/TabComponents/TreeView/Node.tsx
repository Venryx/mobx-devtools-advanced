...
export class Node extends React.Component<
{
	...
	hovered?: boolean,
	searchRegExp?: RegExp,
	scrollTo?: (node: any) => any,
	onToggleCollapse?: () => any,
	onHover?: (hovered: boolean) => any,
	onHoverBottom?: (hovered: boolean) => any,
	onSelect?: () => any,
	onSelectBottom?: () => any,
	onContextMenu?: () => any,
...
> {
	...
	render() {
		...
		let name: string | JSX.Element = `${node.name}`;
...
class Head extends React.Component<
	{depth: number, hovered: boolean, selected: boolean, children: any, getRef: (c) => any},
	{}
> {
	render() {
		const {depth, hovered, selected, children, getRef, ...otherProps} = this.props;
		return (
			<div
				ref={getRef}
...
class Tail extends React.Component<{depth: number, hovered: boolean, selected: boolean, children: any, getRef: (c) => any}, {}> {
	render() {
		const {depth, hovered, selected, children, getRef, ...otherProps} = this.props;
		return (
			<div ref={getRef} {...otherProps} className={css(styles.tail, hovered && styles.tailHovered, selected && styles.tailSelected)}>
				<span
					style={{paddingLeft: calcPaddingLeft(depth)}}
					className={css(styles.content, selected && styles.selectedContent)}
				>
...
class Guideline extends React.Component<{depth: number, hovered: boolean, selected: boolean}> {
	render() {
